...
export const developers: Developer[] = [
  ...
  },
  {
    ...
    tagline: 'React-интерфейсы с акцентом на скорость и чистую структуру.',
    telegram: 'https://t.me/RainTetei',
    telegramLabel: '@RainTetei',
    email: 'mailto:tetej032@gmail.com',
    emailLabel: 'tetej032@gmail.com',
  },
  {
    id: 'open-role',
    name: 'ИЩЕМ РАЗРАБОТЧИКА',
    role: 'ОТКРЫТА ВАКАНСИЯ',
    tagline: 'Если тебе близок наш стиль работы, напиши нам и присоединяйся к команде.',
    telegram: 'https://t.me/alexdan_www',
    telegramLabel: '@alexdan_www',
    email: 'mailto:alexdartx@yandex.ru',
    emailLabel: 'alexdartx@yandex.ru',

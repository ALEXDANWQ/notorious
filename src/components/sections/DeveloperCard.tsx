...
export function DeveloperCard({ developer, index }: DeveloperCardProps) {
  ...
  return (
    <m.article
      className="group relative h-full overflow-hidden rounded-2xl border border-zinc-700/70 bg-zinc-900/20 p-4 transition-all duration-200 hover:border-white/30 hover:bg-white/[0.03] sm:p-6"
    ...
    >
      ...
      <div className="mt-5 space-y-2 border-t border-zinc-700/70 pt-3 transition-colors duration-200 group-hover:border-white/15">
        <a
